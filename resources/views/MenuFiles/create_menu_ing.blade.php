...
@section('content')
    ...
    <!-- Begin page content -->
        <div class="container-fluid">
            ...
            {{--<div class="col-md-3">--}}
            {{--<div class="form-group">--}}
            {{--<label for=""><b class="star">*</b></label>--}}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label>Menu *:</label>
                    {!! Form::select('ddlmenu', $menu, null,['class' => 'typeDD']) !!}
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control input-sm required" placeholder="Unit"
                           id="unit_1" readonly="readonly" tabindex="-1" name="itemGstAmt[]">
                </td>
                <td>
    ...
    <script src="{{ url('assets/js/auto_menu_info.js') }}"></script>
    <script>
