...
@section('content')
    ...
    <h3 class="heading bg-success">Generate Dummy Bill</h3>
        ...
        <div class="col-md-12">
            <div class="text-center">
                ...
                <button style="display:none;" type="button" onclick="submitChange();" class="btn btn-primary"
                        id="btnConfirm">Print Dummy Bill
                </button>
...
//            alert(tableId);
            ...
            $('#btnConfirm').show();
            var send_to_url = '{{ url('/') }}' + "/bill/" + tableId + "/filter";
//            alert(send_to_url);
            $.ajax({
                type: "POST",
...
//            $('.rcode').focus();
                ...
                $.ajax({
                    ...
                    url: "{{ url('print_bill') }}",
//                data: '{"data":"' + endid + '"}',
                    data: '{"formData":"' + formData + '", "table_id":"' + table_id + '", "PayableAmt":"' + PayableAmt + '"}',
                    success: function (data) {
//                        if (data == 'ok') {
                        //console.log(data);
                        $('#table_id').val('0');
