...
<table id="" class="table-bordered" cellspacing="0" width="100%">
    ...
    {{--<tr>--}}
        ...
        {{--<td class="text-center">--}}
            {{--<select id="distype" onchange="ChangeDiscountType(this);" name="status" style="width:100%">--}}
                ...
                {{--</optgroup>--}}
            {{--</select></td>--}}
        {{--<td class="text-center"><input type="text" placeholder="Enter Discount" id="discount_txt" class="changesDis" onkeyup="DiscountForpayable(this)" value=""></td>--}}
    ...
    {{--<tr>--}}
        ...
        {{--<td class="text-center">--}}
            {{--<select id="source"  onchange="ChangePaymentMode(this);"  name="status" style="width:100%">--}}
                {{--<optgroup label="Status">--}}
                {{--<option value="0">Select</option>--}}
        ...
        {{--<th class="text-center"><input type="text" class="txthide" id="bank"/></th>--}}
        {{--<th class="text-center"><input type="text" class="txthide" id="chequeno"/></th>--}}
    {{--</tr>--}}
    {{----}}
    {{----}}
    {{--<tr>--}}
