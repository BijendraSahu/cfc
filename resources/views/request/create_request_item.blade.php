...
@section('content')
    <a href="{{url('request_item')}}" class="btn btn-sm bg-danger btnSet btn-primary pull-right">
    ...
    @endif
    {!! Form::open(['url' => 'request_item', 'class' => 'form-horizontal', 'id'=>'issue']) !!}
    ...
    <!-- Begin page content -->
        <div class="container-fluid">
            ...
            {{--<div class="col-md-3">--}}
                {{--<div class="form-group">--}}
                    {{--<label for=""><b class="star">Menu *:</b></label>--}}
